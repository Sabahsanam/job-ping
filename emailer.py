...
JOB_PING_QUOTES = [
    ...
    "It's a need to travel. ✈️",
    "Your future apartment would like to be a penthouse. 🏙️",
    ...
    "December graduation is coming. Gotta lock IN!.",
    "Job Ping said GET UP 📢",
    "Unfortunately, our expensive taste requires employment.",
    "Money cannot buy happiness. It can, however, buy plane tickets, ehehehehhehe!.",
