...
class GitHubConnector(JobConnector):

    API_URL = "https://www.github.careers/api/jobs"
    JOB_BASE_URL = "https://www.github.careers/careers-home/jobs"
    ...
    def fetch_jobs(self):
        ...
        while True:
            ...
            print(
                f"Loading GitHub jobs page {page}..."
            )
            ...
            # Jibe normally returns 10 per page.
            ...
            if page > 100:
                print(
                    "Stopped GitHub pagination "
                    "at 100 pages for safety."
                )
                break
